const CACHE='zhuxi-v39-apk-local';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./moods/mood1.png','./moods/mood2.png','./moods/mood3.png','./moods/mood4.png','./moods/mood5.png','./moods/mood6.png','./moods/mood7.png','./moods/mood8.png','./moods/mood9.png','./focus-mushroom.gif'];
